...
const Blogs = () => {
    return (
        <div className='container text-secondary px-24 grid grid-flow-row gap-y-12'>
                <div className='mt-12'>
                    <h2 className="text-xl">Difference Between Javascript and NodeJS</h2>
                    <div>
                ...
                <div>
                    <h2 className="text-xl">When Should You Use NodeJS and When Should You Use MongoDB</h2>
                    <div>
                ...
                <div>
                    <h2 className="text-xl">Differences Between SQL and NoSQL databases.</h2>
                    <div>
                ...
                <div>
                    <h2 className="text-xl">What Is The Purpose of JWT and How Does It Work?</h2>
                    <div>
